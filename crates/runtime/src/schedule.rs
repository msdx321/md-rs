...
use media_config::schedule::{Mode, Schedule};
...
pub struct Timer {
    module: Module,
    updates: watch::Receiver<media_config::app::Config>,
    pub config: Schedule,
    pub next: Option<DateTime<Local>>,
}
impl Timer {
    pub fn new(mut updates: watch::Receiver<media_config::app::Config>, module: Module) -> Self {
